jQuery(document).ready(function ($) {
	...
	var ManGoCube_settings = {
		...
		color: function() {
			...
			$( '.mangocube-color-picker' ).wpColorPicker();
		},
		/*=Date Picker Field */
		date: function() {
			//$('.mangocube-datepicker').datepicker();	
		},
		...
		media: function() {
			...
			$('body').on('click', '.mangocube-media-delete-button', function(e) {
				e.preventDefault();
			...
			$('body').on('click', '.mangocube-media-button', function(e) {
				e.preventDefault();
		...
		repeat: function() {
			var $parent = $('.mangocube-repeat-table-wrap');
