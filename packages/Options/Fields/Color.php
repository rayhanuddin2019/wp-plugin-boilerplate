...
class Color extends Base_Field {
	...
	?>
		<input type="text" class="mangocube-color-picker" name="<?php echo esc_attr($this->option_name); ?>" id="<?php echo esc_attr($this->option_id); ?>" value="<?php echo esc_attr( $this->value ); ?>">
