...
class Mangocube_Settings_API {
	...
	public function __construct( $configs = array(), $sections = array() ) {
		...
		$this->mangocube_admin = new Mangocube_Admin($this);
	
		$this->sections = $this->array_sort( 
			apply_filters( 'mangocube_sections', $sections ), 
			'priority', 
			SORT_ASC 
		);

		$this->mangocube_settings = new Mangocube_Settings($this);
		$this->mangocube_views = new Mangocube_Views($this);
