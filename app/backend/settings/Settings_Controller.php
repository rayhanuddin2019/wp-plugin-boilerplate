...
Class Settings_Controller {
    ...
    function sample_setings_setup() {
        ...
        $sections['blank'] = array(
            ...
            'id'	=> 'blank',
            'type'	=> 'blank',
            'callback' => [$this,'sample_blank_callback'],
            'priority'	=> 36,
        );
    
        $configs = array(
            // This is where your data is stored in the database and also becomes your global variable name.
            'opt_name' 			=> 'mangocube_sample_options',
            ...
            // Admin menu title
            'menu_title' 		=> 'MangoCube Options',
            // Page title of admin menu page 
            'page_title' 		=> 'MangoCube Options',
            ...
            'page_slug'         => '_mangocube_sample_options',
        ...
        $sample_settings_configs = new Settings_Api(
            $configs, 
    ...
    public function sample_blank_callback(){
